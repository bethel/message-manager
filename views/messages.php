            ...
            <div class="four columns">
                ...
                <div class="panel">
                    ...
                    <a href="http://live.bethelfc.com" title="Watch Bethel Live">
                        <img src="<?php echo Message_Manager::find_theme_url('watch_bethel_live_small.jpg') ?>"
                ...
                <div class="panel">
                    ...
                    <ul>
                        ...
                        <li>Subscribe using <a title="Subscribe to sermons RSS feed podcast"
                                               href="http://feeds.feedburner.com/bethelchurchsermons" target="_blank">RSS</a>&nbsp;
                        </li>
                        <li>Subscribe by <a
                    ...
                    <p>Visit our <a href="<?php echo home_url('/podcast'); ?>" title="Podcast">podcast page</a> if you
                        have questions about podcasting.</p>

                    <p>Sermons can also be heard on LIFE 97.9 FM, Sundays at 8:30 a.m. and on FAITH 1200 AM Sundays at
