	...
	<div id="main" class="twelve columns clearfix" role="main">
		...
		<div class="row">
			<div class="eight columns">
				...
				<span class="message-manager-meta"><?php Message_Manager::the_speakers($message); ?> / <?php Message_Manager::the_date($message); ?> / <?php Message_Manager::the_verse($message); ?></span>
