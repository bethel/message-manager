...
<?php get_header(); ?>
			...
			<div id="content" class="clearfix message_manager_series">
				...
				<div class="row clearfix">
					<div class="three columns"><?php Message_Manager::the_image($series, Message_Manager::$tax_series); ?></div>
				...
				<?php
					...
					<div class="three columns<?php echo ($end)? ' end' : ''; ?> message_manager_message_box">
						...
						<a href="<?php Message_Manager::the_link($message); ?>">
							<?php Message_Manager::the_image($message, Message_Manager::$cpt_message); ?>
