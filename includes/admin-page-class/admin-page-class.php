...
if ( ! class_exists( 'MM_Admin_Page_Class') ) :
 ...
 */
  ...
  class MM_Admin_Page_Class {
    ...
    public function __construct($args) {
      ...
      $this->SelfPath = Message_Manager::$url .'includes/admin-page-class';
    ...
    /**
      ...
      public function DisplayPage() {
        ...
        wp_nonce_field( basename(__FILE__), 'MM_Admin_Page_Class_nonce' );
...
.at-repater-block{background-color: #FFFFFF;border: 1px solid;margin: 2px;}
  ...
  public function save($repeater = false) {
    ...
    //check nonce
    if ( ! check_admin_referer( basename( __FILE__ ), 'MM_Admin_Page_Class_nonce') )
      return;
    ...
    foreach ( $this->_fields as $field ) {
      if(!in_array($field['type'],$skip)){
        ...
        // Validate meta value
        if ( class_exists( 'MM_Admin_Page_Class_Validate' ) && method_exists( 'MM_Admin_Page_Class_Validate', $field['validate_func'] ) ) {
          $new = call_user_func( array( 'MM_Admin_Page_Class_Validate', $field['validate_func'] ), $new );
        }
