...
if ( ! class_exists( 'MM_Tax_Meta_Class') ) :
...
class MM_Tax_Meta_Class {
  ...
  */
  public function wp_ajax_delete_image() {
    ...
    $ok = false;
    $remove_meta_only = apply_filters("MM_Tax_Meta_Class_delete_image",true);
  ...
  public function show($term_id) {
    ...
    wp_nonce_field( basename(__FILE__), 'MM_Tax_Meta_Class_nonce' );
...
.at-repater-block{background-color: #FFFFFF;border: 1px solid;margin: 2px;}
  ...
  public function save( $term_id ) {
    ...
    || ( ! check_admin_referer( basename( __FILE__ ), 'MM_Tax_Meta_Class_nonce') )    // Check nonce - Security
