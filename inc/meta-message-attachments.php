<div class="mm_admin_box mm_admin_attachments">
    ...
    <p>The attachments section allows you upload or reference files that support the message. e.g. transcripts,
        outlines, notes, slides, etc.
    ...
    <table class="form-table">
        ...
        <tr class="mm-attachment-url">
            ...
            <td>
                ...
                <input type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"
                       class="regular-text"/>
                <input class="button media_button" type="button" value="Upload Attachment"
                       data-title="Choose Attachment" data-select="Select Attachment"/>
        ...
        <tr class="mm-attachment-title">
            ...
            <td><input type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"
                       class="regular-text"/>
